...
%>
  ...
  <div class='main_content'>
    <form name='formulario' method='post' class='texto' enctype='multipart/form-data' action="update_ocd.jsp">
      <input type='hidden' name='id' value='' />      
      <center><font class='titulo'>Edit OCD</font><br><br></center>
...
<%						} %>	
        ...
        <tr>        
        	<td>Fusion rules</td> 
        		<td>
          			<input type='file' name='rules' width=" 400px" ><%=fusionRules%>
          ...
          <tr>
        	...
        	<td width=200px> <input type='text' name='accesskey' value="<%=accesskey%>" style='width: 400px;' /> </td>
        </tr>    
