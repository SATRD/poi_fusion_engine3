...
<% Logger log = Logger.getLogger("JSP.update_apitype");%>
...
<%    	    
	...
	//Obtain form parameters and save APIRules file (this is a multipat message; thus request.getParameter() will not work)
        ...
        if (state.isEmpty()){	
        	...
        	if ((name!=null)&& (!name.isEmpty()) ){	
                ...
                //search if the new name is already there in the DB	
        	       ...
        	       APIType apitype1 = APIType.getAPITypeClassByName(con,name,null);
        	       
        	       
        	       APIType apitype2 = APIType.getAPITypeClassById(con,new Integer(id),null);
        	        
        	       
        	       boolean name_keeps = apitype2.getName().equalsIgnoreCase(name);
       	        
       	        	
       	        	if ((apitype1 == null) || name_keeps   ){
        	       
        	       
        	        	apitype2.setName(name);
        	        	apitype2.setDescription(description);
        	        	    	        	
        	        	
        	    		boolean res = APIType.updateAPIType(con, apitype2,null);  
        	    		
        	    		
        	    		if (res){
        	    			error = 0;
        	    			state = "APIType updated properly";
        	    		}else{
        	    			error = 1;
        	    			state = "There was a problem updating the APIType";
