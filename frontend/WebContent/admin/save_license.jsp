...
<% Logger log = Logger.getLogger("JSP.save_license");%>
...
<%    
    ...
    try{         
        ...
        if ((name!=null)&& (!name.isEmpty()) ){	
	        ...
	        License license = License.getLicenseClassByName(con,name,null); 
	        
	        if (license == null){
	        	
	        	License license2 = new License(name,description,info);
	    		int id_selec = License.saveLicense(con, license2,null); 
	    		...
	    		if (id_selec > 0){
	    			...
	    			error = 1;
	    			state = "There was a problem storing the lincese";
