...
<% Logger log = Logger.getLogger("JSP.new_apitype");%>
...
<body bgcolor="white" style="{ margin:0;}" background="../img/centerf2.png" style="{ background-repeat: no-repeat;}">
  ...
  <div class='main_content'>
    <form name='formulario' method='post' class='texto' enctype='multipart/form-data' action="save_apitype.jsp">
      <input type='hidden' name='id' value='' />      
      <center><font class='titulo'>New APIType</font><br><br></center>
